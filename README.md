...
!\[Badge Status](https://img.shields.io/badge/Status-Prototype-orange) !\[Badge Hackathon](https://img.shields.io/badge/Hackathon-3rd\_Place\_Winner-yellow) !\[Badge Tech](https://img.shields.io/badge/Tech-n8n\_|\_OpenAI\_|\_OCR-blue)
...
!\[Dashboard Preview](assets/dashboard\_preview.png)
...
!\[Demonstração do Chat](assets/print\_conversa.png)
...
!\[Workflow n8n](assets/workflow\_diagram.png)
...
2\.  Importe o arquivo `workflows/FinancaPro\_Workflow.json` na sua interface.
